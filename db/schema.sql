-- ============================================================================
-- GourmetAdvisor · 菜谱库 Schema v0.2
-- 项目代号:GourmetAdvisor · 内部代号 03-美食 · 2026-08-26(初版)→ 2026-09-04 增 11 tag
-- 关联文件:项目开发计划.md Phase 0 · 任务 6 (设计菜谱表)
-- 引擎:SQLite 3(Phase 0) → PostgreSQL 14+(Phase 1 迁移)
-- 设计原则:5 张主表 + 1 张多对多桥接表,留好 FK 与索引
-- 变更记录:
--   v0.1 2026-08-26  初版 · 8 大菜系 + 4 风味 + 6 场景 + 7 饮食 = 25 tag
--   v0.2 2026-09-04  补幽灵 tag(中式/海鲜/酸辣/咸甜/糊辣/香辣/早餐/凉菜/汤品/煲汤/蒸菜)= 11 tag
--                    解决 seed_recipes.sql 第 31-35 道用 tag 但桥接静默丢失的问题
-- ============================================================================
...
-- ============================================================================
-- 初始化:塞入 8 大菜系 + 补充中式 = 9 大类 + 风味/场景/饮食 = 36 tag
-- ============================================================================
INSERT OR IGNORE INTO tag (name, category) VALUES
    -- 菜系(9 · v0.2 补「中式」)
    ('川菜', 'cuisine'), ('鲁菜', 'cuisine'), ('粤菜', 'cuisine'),
    ('淮扬菜', 'cuisine'), ('浙菜', 'cuisine'), ('闽菜', 'cuisine'),
    ('徽菜', 'cuisine'), ('湘菜', 'cuisine'), ('中式', 'cuisine'),
    -- 风味(10 · v0.2 补「海鲜/酸辣/咸甜/糊辣/香辣」)
    ('麻辣', 'flavor'), ('咸鲜', 'flavor'), ('清淡', 'flavor'), ('酸甜', 'flavor'),
    ('酸辣', 'flavor'), ('咸甜', 'flavor'), ('糊辣', 'flavor'), ('香辣', 'flavor'),
    ('海鲜', 'flavor'),
    -- 场景(10 · v0.2 补「早餐/凉菜/汤品/煲汤/蒸菜」)
    ('快手', 'scenario'), ('宴客', 'scenario'), ('便当', 'scenario'), ('宵夜', 'scenario'),
    ('甜品', 'scenario'), ('微波', 'scenario'), ('早餐', 'scenario'),
    ('凉菜', 'scenario'), ('汤品', 'scenario'), ('煲汤', 'scenario'), ('蒸菜', 'scenario'),
    -- 饮食目标(7 · v0.1 全留)
